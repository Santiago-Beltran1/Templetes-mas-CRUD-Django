...
ROOT_URLCONF = 'examen_clase.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug',       # recomendado en desarrollo
...
WSGI_APPLICATION = 'examen_clase.wsgi.application'
...
# Media (para ImageField / FileField)
MEDIA_URL = '/media/'
